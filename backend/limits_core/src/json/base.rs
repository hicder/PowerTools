    ...
    fn default() -> Self {
        Base {
            configs: vec![
                ...
                super::Config {
                    name: "AMD Ryzen Z1 Extreme".to_owned(),
                    conditions: super::Conditions {
                        dmi: None,
                        cpuinfo: Some("model name\t+: AMD Ryzen Z1 Extreme\n".to_owned()),
                        os: None,
                        command: None,
                        file_exists: None,
                    },
                    limits: vec![
                        super::Limits::Cpu(super::CpuLimit::GenericAMD(super::GenericCpuLimit {
                            clock_min: Some(super::RangeLimit { min: Some(400), max: Some(6000) }),
                            clock_max: Some(super::RangeLimit { min: Some(400), max: Some(6000) }),
                            clock_step: 100,
                        })),
                        super::Limits::Gpu(super::GpuLimit::GenericAMD(super::GenericGpuLimit {
